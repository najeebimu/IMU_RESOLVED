...
public class FinalRemarks extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FinalRemarks.this, FormSaving.class));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FinalRemarks.this, MonitorSignature.class));
                overridePendingTransition(R.anim.fadein, R.anim.fadeout);
            }
        });
    }
    ...
    protected void onPause() {
        ...
        editor.putString("finalremarks", et1.getText().toString());
        editor.apply();
    }
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences preferences = getSharedPreferences("STOREDVALUES", MODE_PRIVATE);
        String s = preferences.getString("finalremarks", " ");
        et1.setText(s);
    }
}
