...
public class Y_EnrollementAgeBoysMain extends Activity {
    DatabaseHandler databasehandler;
    DetailsEnrollmentAgeBoys details;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DetailsEnrollmentAgeBoys eag = databasehandler.getEAgeboys(emis, classNumber);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                details = new DetailsEnrollmentAgeBoys();
                ...
                databasehandler.saveEAgeboys(details);
                startActivity(new Intent(Y_EnrollementAgeBoysMain.this, Y_EnrollmentAgeBoys.class));
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(Y_EnrollementAgeBoysMain.this);
