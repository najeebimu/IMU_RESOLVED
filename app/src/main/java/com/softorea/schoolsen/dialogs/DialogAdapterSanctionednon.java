...
public class DialogAdapterSanctionednon extends BaseAdapter {
    ...
    public DialogAdapterSanctionednon(Context context, ArrayList<DetailsSanctionedNonteachingPosts> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.dialogadapternonsanctioned, null);
