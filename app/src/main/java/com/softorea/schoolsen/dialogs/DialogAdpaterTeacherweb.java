...
public class DialogAdpaterTeacherweb extends BaseAdapter {
    ...
    public DialogAdpaterTeacherweb(Context context, ArrayList<DetailsTeacherwebservice> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        holder.designation.setText(searchArrayList.get(p).getTeachergender());
