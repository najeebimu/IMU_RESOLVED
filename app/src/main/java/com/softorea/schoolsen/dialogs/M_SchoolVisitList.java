...
import com.softorea.schoolsen.m_monthly.M_SchoolVisits;
...
public class M_SchoolVisitList extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialogvisit);
    ...
    private void SavingInDb() {
        ...
        cusadapter = new DialogAdapterVisit(M_SchoolVisitList.this, addas);
