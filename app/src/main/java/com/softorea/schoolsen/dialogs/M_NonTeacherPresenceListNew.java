...
public class M_NonTeacherPresenceListNew extends Activity {
    Button back;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databasehandler = new DatabaseHandler(M_NonTeacherPresenceListNew.this);
    ...
    private void Rsults() {
        ...
        cusadapter = new DialogAdapterNonteacher(M_NonTeacherPresenceListNew.this, addas);
