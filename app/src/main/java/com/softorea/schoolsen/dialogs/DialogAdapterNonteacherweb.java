...
public class DialogAdapterNonteacherweb extends BaseAdapter {

    private static ArrayList<DetailsNonTeacherwebservice> searchArrayList;
    DatabaseHandler databaseHandler;
    private Context context;
    private LayoutInflater mInflater;

    public DialogAdapterNonteacherweb(Context context, ArrayList<DetailsNonTeacherwebservice> results) {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.dialogadapternonteacher, null);
        ...
        holder.no.setText(searchArrayList.get(position).getTeacherno());
        holder.designation.setText(searchArrayList.get(position).getTeachergender());
        holder.status.setText(searchArrayList.get(position).getAttendance());
        holder.attdetails.setText(searchArrayList.get(position).getTeacherattendancedetails());
    ...
    static class ViewHolder {
        TextView name, cnic, no, designation, status,attdetails;
