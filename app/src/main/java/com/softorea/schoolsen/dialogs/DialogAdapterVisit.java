...
public class DialogAdapterVisit extends BaseAdapter {
    ...
    public DialogAdapterVisit(Context context, ArrayList<DetailsSchoolVisit> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.dialogadaptervisit, null);
