...
public class CustomAdapterApointedBy extends BaseAdapter {
    ...
    public CustomAdapterApointedBy(Context context, ArrayList<DetailsAppointedBy> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.customlist_appointedby, null);
