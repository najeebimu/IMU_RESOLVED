...
public class CustomAdapterVacantPosition extends BaseAdapter {
    ...
    public CustomAdapterVacantPosition(Context context, ArrayList<DetailsVacant> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.customlist_vacant, null);
