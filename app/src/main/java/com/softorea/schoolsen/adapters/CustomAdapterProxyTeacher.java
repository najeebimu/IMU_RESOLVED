...
public class CustomAdapterProxyTeacher extends BaseAdapter {
    ...
    public CustomAdapterProxyTeacher(Context context, ArrayList<DetailsProxyTeacher> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.customlist_proxyteacher, null);
