...
public class CustomAdapterSanctionedPosts extends BaseAdapter {
    ...
    public CustomAdapterSanctionedPosts(Context context, ArrayList<DetailsSanctionedPosts> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.customlist_sanctionedposts, null);
