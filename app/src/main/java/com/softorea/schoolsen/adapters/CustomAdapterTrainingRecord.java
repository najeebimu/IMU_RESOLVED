...
public class CustomAdapterTrainingRecord extends BaseAdapter {
    ...
    public CustomAdapterTrainingRecord(Context context, ArrayList<TrainingRecord> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.customlist_training, null);
