...
public class CustomAdapterNonTeacherWebservice extends BaseAdapter {
    ...
    public CustomAdapterNonTeacherWebservice(Context context, ArrayList<DetailsNonTeacherwebservice> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = mInflater
                    .inflate(R.layout.nonteacherwebserviceadapter, null);
        ...
        holder.info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent view_order_intent = new Intent(context, NonTeacherwebservicemainlistupdate.class);
