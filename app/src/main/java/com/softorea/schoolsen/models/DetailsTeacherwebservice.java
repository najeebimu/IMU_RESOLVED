...
public class DetailsTeacherwebservice {
    private int id;
    ...
    public DetailsTeacherwebservice() {
    }

    public DetailsTeacherwebservice(String emisCode, String teachername, String teachergender, String teacherno,
    ...
    public DetailsTeacherwebservice(int id, String emisCode, String teachername, String teachergender, String teacherno,
                             String teachercnic, String teacherattendance, String teacherattendancedetails,
                                    String attendancedatesince, String attendancetrasnferschool) {
        this.id = id;
        this.emisCode = emisCode;
