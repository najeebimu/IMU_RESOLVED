...
/**
 * Created by Softorea on 10/25/2017.
 */
...
public class MoreInfo extends Activity {
    ...
    Button btnRight;
    RadioGroup flagGroup;
    RadioGroup grantGroup;
    RadioButton flagyes, flagno, grantyes, grantno;
    String flagcheck, grantcheck;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.m_monthlymoreinfo);

        btnLeft = (Button) findViewById(R.id.btn_left);
        btnRight = (Button) findViewById(R.id.btn_right);
        grantGroup = (RadioGroup) findViewById(R.id.grant_group);
        flagGroup = (RadioGroup) findViewById(R.id.flag_group);


        flagyes = (RadioButton) findViewById(R.id.flag_yes);
        flagno = (RadioButton) findViewById(R.id.flag_no);
        grantyes = (RadioButton) findViewById(R.id.grant_yes);
        grantno = (RadioButton) findViewById(R.id.grant_no);

        btnLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MoreInfo.this, M_VacantPositionsList.class));
                overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                finish();
            }
        });

        flagGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.flag_yes) {
                    flaggroup = "Yes";
        ...
        grantGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.grant_yes) {
                    grantgroup = "Yes";
        ...
        btnRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MoreInfo.this);
                ...
                SQLiteOpenHelper database = new DatabaseHandler(MoreInfo.this);
                ...
                cursorform.close();
                dbd.close();
                if (flaggroup.equals("Null") || grantgroup.equals("Null"))
                {
                    Toast.makeText(MoreInfo.this, "Please fill the fields", Toast.LENGTH_SHORT).show();
                }
                else if (schoolareaStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_SchoolArea.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (constructionStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_Construction.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (buildindconditionStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_BuildingCondition.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (itlabStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_IT_LabExists.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                ...
                {
                    startActivity(new Intent(MoreInfo.this, B_Commodities.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (ptcStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_ParentTeacherCouncil.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                ...
                {
                    startActivity(new Intent(MoreInfo.this, B_Stipend.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (infrastructureStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_InfraStructure.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (guideStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_TeacherGuides.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (cleanlinessStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, B_Cleanliness.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (SanctionedStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, M_SanctionedPostList.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (indicatorStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, Y_OtherFacilities.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (enrollmentageStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, Y_EnrollmentAgeBoys.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                        ...
                        || hsec.equals("HighSecondarySelected")))
                {
                    startActivity(new Intent(MoreInfo.this, Y_EnrollmentByGroupSectionMain.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (disabledStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, Y_SpecialBoysMain.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (securityStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, Y_SecurityMeasures.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (ftbStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, Y_ProvisionFreeBooksMain.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else if (furnitureStr.equals("True"))
                {
                    startActivity(new Intent(MoreInfo.this, Y_Furniture.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
                else
                {
                    startActivity(new Intent(MoreInfo.this, CompleteForm.class));
                    overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                    finish();
                }
            }
    ...
    protected void onPause() {
        ...
        editor.putString("flagcheck", flaggroup);
        editor.putString("grantcheck", grantgroup);
        editor.apply();
    }
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences preferences = getSharedPreferences("STOREDVALUES", MODE_PRIVATE);
        String namee = preferences.getString("flagcheck", "");
        String cnicc = preferences.getString("grantcheck", "");
        if (namee.equals("Yes")) {
            flagyes.setChecked(true);
            flagno.setChecked(false);
        } else if (namee.equals("No")) {
            flagno.setChecked(true);
            flagyes.setChecked(false);
        } else {
            flagyes.setChecked(false);
            flagno.setChecked(false);
        }
        if (cnicc.equals("Yes")) {
            grantyes.setChecked(true);
            grantno.setChecked(false);
        } else if (cnicc.equals("No")) {
            grantno.setChecked(true);
            grantyes.setChecked(false);
        } else {
            grantyes.setChecked(false);
            grantno.setChecked(false);
        }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(MoreInfo.this);
