...
public class NonTeacherPresence extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nonteacherpresence);
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        emis = preferences.getString("emiscode", "");
        databasehandler = new DatabaseHandler(NonTeacherPresence.this);
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(NonTeacherPresence.this, datea, txtdate
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(NonTeacherPresence.this, M_NonTeacherPresenceList.class));
            }
        });
