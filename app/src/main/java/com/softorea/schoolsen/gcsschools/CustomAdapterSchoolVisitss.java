...
public class CustomAdapterSchoolVisitss extends BaseAdapter {
    ...
    public CustomAdapterSchoolVisitss(Context context, ArrayList<DetailsSchoolVisit> results) {
    ...
    public View getView(final int p, View v, ViewGroup parent) {
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, com.softorea.schoolsen.gcsschools.M_SchoolVisitsUpdate.class);
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                // final String visitdate = searchArrayList.get(p).getVisitdate();
                //final String visitby = searchArrayList.get(p).getVisitby();
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                context.startActivity(new Intent(context, com.softorea.schoolsen.gcsschools.M_SchoolVisitList.class));
                            }
                        });
