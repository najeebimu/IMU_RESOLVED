...
public class M_Enrollment_AttendanceGapFive extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(M_Enrollment_AttendanceGapFive.this, M_Enrollment_AttendanceGap.class));
    ...
    protected void onPause() {
        ...
        editor.putString("stdregistered_five", stdregisterred.getText().toString());
        editor.putString("stdpresent_five", stdpresent.getText().toString());
        editor.putString("enrollment_girlsinboys_five", girlsinboys.getText().toString());
        editor.putString("enrollment_boysingirls_five", boysingirls.getText().toString());
        editor.apply();
    }
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences preferences = getSharedPreferences("STOREDVALUES", MODE_PRIVATE);
        String enrolled = preferences.getString("stdregistered_five", "");
        String presenthead = preferences.getString("stdpresent_five", "");
        String GinBoys = preferences.getString("enrollment_girlsinboys_five", "");
        String BinGirls = preferences.getString("enrollment_boysingirls_five", "");
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(M_Enrollment_AttendanceGapFive.this);
