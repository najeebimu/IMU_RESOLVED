...
public class M_Enrollment_AttendanceGapTwo extends Activity {
    Button back;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(M_Enrollment_AttendanceGapTwo.this, M_Enrollment_AttendanceGap.class));
    ...
    protected void onPause() {
        ...
        editor.putString("stdregistered_two", stdregisterred.getText().toString());
        editor.putString("stdpresent_two", stdpresent.getText().toString());
        editor.putString("enrollment_girlsinboys_two", girlsinboys.getText().toString());
        editor.putString("enrollment_boysingirls_two", boysingirls.getText().toString());
        editor.apply();
    }
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences preferences = getSharedPreferences("STOREDVALUES", MODE_PRIVATE);
        String enrolled = preferences.getString("stdregistered_two", "");
        String presenthead = preferences.getString("stdpresent_two", "");
        String GinBoys = preferences.getString("enrollment_girlsinboys_two", "");
        String BinGirls = preferences.getString("enrollment_boysingirls_two", "");
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(M_Enrollment_AttendanceGapTwo.this);
