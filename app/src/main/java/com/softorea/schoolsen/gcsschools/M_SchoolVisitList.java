...
public class M_SchoolVisitList extends Activity {
    ...
    CustomAdapterSchoolVisitss cusadapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(M_SchoolVisitList.this, com.softorea.schoolsen.gcsschools.M_Enrollment_AttendanceGap.class));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(M_SchoolVisitList.this, M_TeacherDetails.class));
                overridePendingTransition(R.anim.fadein, R.anim.fadeout);
                finish();
            }
        });
    ...
    private void SavingInDb() {
        ...
        cusadapter = new CustomAdapterSchoolVisitss(M_SchoolVisitList.this, addas);
