...
public class M_Enrollment_AttendanceGapOne extends Activity {
    Button back;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(M_Enrollment_AttendanceGapOne.this, M_Enrollment_AttendanceGap.class));
    ...
    protected void onPause() {
        ...
        editor.putString("stdregistered_one", stdregisterred.getText().toString());
        editor.putString("stdpresent_one", stdpresent.getText().toString());
        editor.putString("enrollment_girlsinboys_one", girlsinboys.getText().toString());
        editor.putString("enrollment_boysingirls_one", boysingirls.getText().toString());
        editor.apply();
    }
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences preferences = getSharedPreferences("STOREDVALUES", MODE_PRIVATE);
        String enrolled = preferences.getString("stdregistered_one", "");
        String presenthead = preferences.getString("stdpresent_one", "");
        String GinBoys = preferences.getString("enrollment_girlsinboys_one", "");
        String BinGirls = preferences.getString("enrollment_boysingirls_one", "");
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(M_Enrollment_AttendanceGapOne.this);
